 ...
 * seed-recording.ts
 * 
 * Inserta una grabación de prueba vinculada a evt-seed-001.
 * 
 * USO:
 *   npx ts-node prisma/seed-recording.ts [muxPlaybackId]
 * 
 * Si no pasás un playbackId, usa uno público de demo de Mux.
 * 
 * NOTA: El muxPlaybackId debe existir en tu cuenta Mux o ser un
 * asset público. Para demo sin Mux real, Mux ofrece este asset público:
...
// Mux tiene un video de demo público (no requiere signed URL)
